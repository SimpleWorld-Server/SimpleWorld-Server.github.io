...
async function prepareArticleTagColors(app, localeOptions) {
  const start = performance.now();
  const blog = isPlainObject2(localeOptions.blog) ? localeOptions.blog : {};
...
import { entries as entries5, isLinkAbsolute as isLinkAbsolute2, isLinkHttp, isPlainObject as isPlainObject3 } from "@vuepress/helper";
